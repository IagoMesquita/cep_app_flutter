...
abstract interface class GetCepDetailsByCepRemoteDataSource {
  Future<Either<CepRemoteException, AddressModel>> call(SearchByCepParams cepParam);
}
...
class GetCepDetailsByCepRemoteDataSourceImpl implements GetCepDetailsByCepRemoteDataSource {
  ...
  @override
  Future<Either<CepRemoteException, AddressModel>> call(SearchByCepParams cepParam) async {
    final cepEither = await _apiService.get('/${cepParam.cep}/json/');
